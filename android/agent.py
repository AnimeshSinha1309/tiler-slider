...
# Simulator args.
flags.DEFINE_string('avd_name', 'tiler_slider', 'Name of AVD to use.')
flags.DEFINE_string('android_avd_home', '/home/animesh/.android/avd', 'Path to AVD.')
flags.DEFINE_string('android_sdk_root', '/home/animesh/Android/sdk', 'Path to SDK.')
flags.DEFINE_string('emulator_path', '/home/animesh/Android/Sdk/emulator/emulator', 'Path to emulator.')
flags.DEFINE_string('adb_path', '/home/animesh/Android/Sdk/platform-tools/adb', 'Path to ADB.')
flags.DEFINE_bool('run_headless', False, 'Whether to display the emulator window.')

# Environment args.
flags.DEFINE_string(
    'task_path',
    '/home/animesh/Code/Research/tiler-slider/android/task-tiles/match_tiles.textproto',
    'Path to task textproto file.'
)
